...
public String pageTitle="签约";

public Map < String, List < String> > testMap;

public Map < String,String > extraInfo;

public List< ShopVO > shopList;

public AppQueryResponse queryApps(AppQueryRequest request );
...
public class OperatorVOTest2 extends Super
implements Serializable
 {
